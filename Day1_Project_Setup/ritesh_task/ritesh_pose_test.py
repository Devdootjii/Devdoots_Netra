...
# MediaPipe Hands & Drawing utilities setup
...
# Window configuration for real-time surveillance feed
...
while cap.isOpened():
    ...
    # Flip image horizontally for intuitive mirror/stream view
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            # Draw real-time skeletal hand connections

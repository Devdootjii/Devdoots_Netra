...
# ==========================================
# 2. AI MODELS INITIALIZATION (PRUNED)
# ==========================================
print("[NETRA ENGINE] Loading YOLOv10n (Nano)...")
yolo_model = YOLO("yolov10n.pt")

mp_pose = mp.solutions.pose
# mp_drawing = mp.solutions.drawing_utils (Removed to stop drawing full skeleton)
pose = mp_pose.Pose(
    static_image_mode=False,
    model_complexity=0, # Changed from 1 to 0 for maximum speed/lowest latency
...
window_title = "NETRA AI | Day 4 Latency Optimized"
...
print("[NETRA ENGINE] Pruned Model Active. High-speed tracking initialized.")
...
while cap.isOpened():
    ...
    # --- RENDER OVERLAYS (OPTIMIZED PRUNING) ---
    ...
    # ONLY draw the 4 required landmarks instead of all 33
    if cached_landmarks:
        h, w, _ = frame.shape
        required_points = [
        ...
        for point in required_points:
            ...
            cv2.circle(frame, (cx, cy), 6, (0, 255, 255), cv2.FILLED) # Yellow dots for tracked joints
